...
const Footer = () => {
    return (
        <footer className="w-full  bg-neutral text-neutral-content p-10">
            <div className="w-11/12 p-5 mx-auto grid grid-cols-1 md:grid-cols-4 lg:grid-cols-4 space-y-5">
                <Fade delay={200}
                    duration={1000}
                    fraction={0.5}>
                    <div className="flex flex-col">
                        ...
                        <p className="">The game heist is a thrilling experience that combines strategy, stealth, and action to create an electrifying gameplay experience. </p>
                    </div></Fade>
                <Fade delay={400}
                    duration={1000}
                    fraction={0.5}>
