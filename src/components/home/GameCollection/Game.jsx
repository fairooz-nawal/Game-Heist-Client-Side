    ...
    return (
        <Slide direction="up">
            <div className="image-full w-[300px] h-[400px] mx-auto shadow-xl relative overflow-hidden rounded-2xl hover:border-4 border-gray-400">
                ...
                <div className="absolute left-[10%] bottom-[-18%] transition delay-150 duration-300 ease-in-out hover:-translate-y-[70%] active:-translate-y-[70%] hover:scale-110 hover:bg-[#2A0557CC] space-y-1 p-5 rounded-2xl">
