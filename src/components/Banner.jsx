        ...
        <div className="carousel w-full h-[350px] lg:h-[700px]">
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <Fade
                    ...
                    duration={1000}
                    fraction={0.5} >
                    <div className="absolute left-[4%] lg:left-[5%]  top-[30%] lg:top-[30%] lg:w-2/5 w-11/12 space-y-3">
                        <div className="w-full p-5 inset-0 bg-black/40 z-40 rounded-lg" >
                ...
                <div className="absolute left-5 right-5 top-[90%] md:top-1/2 flex -translate-y-1/2 transform justify-between">
            ...
            <div id="slide3" className="carousel-item relative w-full">
                ...
                <Fade delay={200}
                    ...
                    fraction={0.5}>
                    <div className="absolute left-[4%] lg:left-[5%]  top-[30%] lg:top-[30%] lg:w-2/5 w-11/12 space-y-3">
                        <div className="w-full p-5 inset-0 bg-black/60 z-40 rounded-lg" >
            ...
            <div id="slide4" className="carousel-item relative w-full">
                ...
                <Fade delay={200}
                    duration={1000}
                    fraction={0.5}>
                    <div className="absolute left-[4%] lg:left-[5%]  top-[30%] lg:top-[20%] lg:w-2/5 w-11/12 space-y-3">
                        <div className=" inset-0 bg-black/60 z-40 rounded-lg" >
